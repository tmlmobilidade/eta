...
func TestCalculateBearing(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := geo.CalculateBearing(tt.from, tt.to)
...
func TestGetAngularDifference(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := geo.GetAngularDifference(tt.bearing1, tt.bearing2)
...
func TestIsValidBearing(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := geo.IsValidBearing(tt.eventBearing, tt.shapeBearing, tt.threshold)
...
func TestCalculateShapeBearings(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := geo.CalculateShapeBearings(tt.nodes)
	...
	t.Run("Last bearing equals previous", func(t *testing.T) {
		...
		result := geo.CalculateShapeBearings(nodes)
		if len(result) < 2 {
