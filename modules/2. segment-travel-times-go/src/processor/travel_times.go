...
func ProcessLineShapes( ctx context.Context, clickhouseClient *clickhouseService.ClickhouseClient, lineShapesMap types.LineShapesMap, hashedShapesByLine *types.HashedShapeIdsByLineArray, settings *types.Settings) {
