...
func TestEncodeCoordinate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := EncodeCoordinate(tt.coord, tt.precision)
...
func TestEncodeCoordinates(t *testing.T) {
	...
	result := EncodeCoordinates(coords, 7)
...
func TestEncodeCoordinatesToSet(t *testing.T) {
	...
	result := EncodeCoordinatesToSet(coords, 7)
...
func TestDecodeGeohash(t *testing.T) {
	...
	encoded := EncodeCoordinate(original, 7)
	decoded := DecodeGeohash(encoded)
