...
func TestFindNearestNodeIndex(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := FindNearestNodeIndex(tt.lon, tt.lat, nodes)
...
func TestChunkLineIntoSegments(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := ChunkLineIntoSegments(tt.coords, tt.segmentLength)
	...
	t.Run("Last point is line end", func(t *testing.T) {
		result := ChunkLineIntoSegments(coords, 50)
		if len(result) > 0 {
...
func TestInterpolatePoint(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := InterpolatePoint(coords, tt.distance)
